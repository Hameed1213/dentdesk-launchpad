...
function MobilePricingCards() {
  return (
    <div className="md:hidden sticky top-[64px] z-20 -mx-6 px-6 pt-2 pb-8 mb-8 bg-white border-b border-[#E2E8F0] grid grid-cols-2 gap-3 items-stretch text-center">
      <div
        style={{
          background: "linear-gradient(135deg, #EBF1FE 0%, #FFFFFF 100%)",
