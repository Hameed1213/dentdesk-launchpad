...
const PILLS: FloatPill[] = [
  { icon: Zap, text: "Live in a day vs sales call", top: "24%", left: "-10%", floatDelay: "0s" },
  { icon: Banknote, text: "£49 vs £125+", top: "16%", right: "0%", floatDelay: "-1.2s" },
  { icon: MessageCircle, text: "WhatsApp support vs ticket queue", top: "70%", left: "-6%", floatDelay: "-2.5s" },
