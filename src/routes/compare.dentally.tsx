...
const PILLS: FloatPill[] = [
  { icon: Banknote, text: "£49 vs £125+ a month", top: "25%", right: "52%", floatDelay: "0s" },
  { icon: CalendarCheck, text: "Online booking included vs Essentials+ only", top: "21%", right: "0%", floatDelay: "-1.2s" },
  { icon: Zap, text: "Live in a day vs sales call required", top: "69%", right: "48%", floatDelay: "-2.5s", hideOnMd: true },
  { icon: MessageCircle, text: "Direct WhatsApp support vs standard chat support", top: "65%", right: "0%", floatDelay: "-3.7s" },
];
