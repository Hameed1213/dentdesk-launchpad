  ...
  return (
    <section ref={sectionRef} className="bg-[#f1f3f7] py-24 px-6 overflow-hidden">
      ...
      >
        ...
        {/* Live in a day banner */}
        <div className="mt-8 rounded-2xl bg-white border border-neutral-200 px-6 sm:px-8 py-5 sm:py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-5 shadow-sm">
          <div className="md:max-w-[640px]">
            <h3 className="text-xl sm:text-2xl md:text-[26px] font-semibold tracking-tight text-[#0F172A] leading-tight">
