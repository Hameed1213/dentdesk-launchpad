  ...
  return (
    <div className="relative rounded-xl border border-border bg-gradient-to-br from-slate-100 to-slate-200 p-4 shadow-sm overflow-hidden min-h-[168px]">
      {charges.map((c, i) => (
        <div
          key={i}
          className="animate-toast-stack absolute left-4 right-4 top-1/2 -translate-y-1/2 rounded-2xl bg-white/95 backdrop-blur-md border border-white shadow-md px-3.5 py-3 opacity-0 transform-gpu will-change-transform"
