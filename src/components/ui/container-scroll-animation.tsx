...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[50rem] md:h-[72rem] flex items-center justify-center relative px-0"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  <motion.div
    ...
    className="max-w-[1750px] -mt-8 mx-auto w-full border-[3px] border-[#3a3a3a] p-1.5 md:p-2 bg-[#1a1a1a] rounded-[12px] shadow-2xl"
  >
