...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-6xl -mt-12 mx-auto h-[36rem] md:h-[44rem] w-full border-2 border-[#3a3a3a] p-2 md:p-3 bg-[#1a1a1a] rounded-[16px] shadow-2xl"
    >
      <div className="h-full w-full overflow-hidden rounded-xl bg-[#F8FAFC]">
        {children}
      </div>
    </motion.div>
  );
